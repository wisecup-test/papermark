...
1. MUST: All logging statements for multi-stage asynchronous operations MUST include structured metadata objects containing relevant operational context such as identifiers, counts, sizes, and batch information.

## Policy Block

- MUST All logging statements for multi-stage asynchronous operations MUST include structured metadata objects containing relevant operational context such as identifiers, counts, sizes, and batch information.
