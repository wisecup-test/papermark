...
1. MUST: Request body validation MUST use schema-based parsing with safe parse semantics, returning structured validation errors when input does not conform to expected message schema.

## Policy Block

- MUST Request body validation MUST use schema-based parsing with safe parse semantics, returning structured validation errors when input does not conform to expected message schema.
