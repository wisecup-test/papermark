...
1. MUST: Progress updates MUST occur at workflow boundaries including document collection start, batch creation, per-batch processing, and auxiliary data generation

## Policy Block

- MUST Progress updates MUST occur at workflow boundaries including document collection start, batch creation, per-batch processing, and auxiliary data generation
