...
1. MUST: Error handlers MUST be registered on all asynchronous stream and event sources to propagate failures and trigger cleanup operations including upload abortion

## Policy Block

- MUST Error handlers MUST be registered on all asynchronous stream and event sources to propagate failures and trigger cleanup operations including upload abortion
