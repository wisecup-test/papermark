...
1. SHOULD: Document filtering for dataroom-scoped chats SHOULD invoke a dedicated filtering service that resolves permitted document identifiers based on dataroom configuration and user permissions.

## Policy Block

- SHOULD Document filtering for dataroom-scoped chats SHOULD invoke a dedicated filtering service that resolves permitted document identifiers based on dataroom configuration and user permissions.
