...
1. MUST: Authentication and authorization checks MUST be performed independently for each HTTP method based on the method's required access level

## Policy Block

- MUST Authentication and authorization checks MUST be performed independently for each HTTP method based on the method's required access level
