...
1. SHOULD: When validation fails, error logs SHOULD record the validation failure type and field path without echoing the invalid input value.

## Policy Block

- SHOULD When validation fails, error logs SHOULD record the validation failure type and field path without echoing the invalid input value.
