...
1. MAY: Task payloads MAY include metadata fields for progress reporting or user-facing status updates

## Policy Block

- MAY Task payloads MAY include metadata fields for progress reporting or user-facing status updates
