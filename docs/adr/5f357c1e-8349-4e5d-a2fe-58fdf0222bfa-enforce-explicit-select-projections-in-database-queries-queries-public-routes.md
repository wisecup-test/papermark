...
1. SHOULD: Queries in public API routes should exclude internal metadata fields such as deletion timestamps, internal identifiers, and audit fields unless explicitly required

## Policy Block

- SHOULD Queries in public API routes should exclude internal metadata fields such as deletion timestamps, internal identifiers, and audit fields unless explicitly required
