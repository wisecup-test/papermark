...
1. MUST: All external JSON payloads received from Lambda invocations, trigger events, or decoded sources MUST be explicitly parsed using a JSON parser before accessing payload properties or passing data to downstream operations

## Policy Block

- MUST All external JSON payloads received from Lambda invocations, trigger events, or decoded sources MUST be explicitly parsed using a JSON parser before accessing payload properties or passing data to downstream operations
