...
1. MAY: Workflows MAY use the ORM findUnique method with nested select projections to retrieve specific related entity fields when only a single record is expected

## Policy Block

- MAY Workflows MAY use the ORM findUnique method with nested select projections to retrieve specific related entity fields when only a single record is expected
