...
1. SHOULD: Task implementations SHOULD use metadata caching mechanisms to communicate progress state to external observers

## Policy Block

- SHOULD Task implementations SHOULD use metadata caching mechanisms to communicate progress state to external observers
