...
1. MUST: Schema validation MUST use safeParse or equivalent non-throwing validation methods that return structured success/failure results

## Policy Block

- MUST Schema validation MUST use safeParse or equivalent non-throwing validation methods that return structured success/failure results
