...
1. MUST: Long-running archive tasks MUST update progress metadata at each major workflow stage using a cache layer with key-value semantics

## Policy Block

- MUST Long-running archive tasks MUST update progress metadata at each major workflow stage using a cache layer with key-value semantics
