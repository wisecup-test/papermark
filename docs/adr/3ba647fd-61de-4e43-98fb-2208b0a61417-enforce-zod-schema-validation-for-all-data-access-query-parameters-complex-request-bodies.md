...
1. SHOULD: Complex request bodies containing multiple validated fields SHOULD use object schemas that validate all fields atomically

## Policy Block

- SHOULD Complex request bodies containing multiple validated fields SHOULD use object schemas that validate all fields atomically
