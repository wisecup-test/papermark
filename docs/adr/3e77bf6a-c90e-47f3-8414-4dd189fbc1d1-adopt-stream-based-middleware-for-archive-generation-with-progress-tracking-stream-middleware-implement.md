...
1. MUST: Stream middleware MUST implement the transform stream interface with chunk processing callbacks that preserve data integrity while performing side effects.

## Policy Block

- MUST Stream middleware MUST implement the transform stream interface with chunk processing callbacks that preserve data integrity while performing side effects.
