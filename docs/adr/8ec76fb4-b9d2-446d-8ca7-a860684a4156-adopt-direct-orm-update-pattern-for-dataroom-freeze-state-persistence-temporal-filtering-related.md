...
1. MUST: Temporal filtering on related entities SHALL use comparison operators against timestamp fields within the query builder rather than post-query filtering in application code

## Policy Block

- MUST Temporal filtering on related entities SHALL use comparison operators against timestamp fields within the query builder rather than post-query filtering in application code
