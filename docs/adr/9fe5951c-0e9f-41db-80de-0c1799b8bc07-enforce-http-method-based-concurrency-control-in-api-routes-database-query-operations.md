...
1. MUST: Database query operations MUST use explicit field selection to minimize data exposure and prevent over-fetching of sensitive fields

## Policy Block

- MUST Database query operations MUST use explicit field selection to minimize data exposure and prevent over-fetching of sensitive fields
