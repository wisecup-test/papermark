...
1. MUST: Before using any versioned library, implementations MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation.

## Policy Block

- MUST Before using any versioned library, implementations MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation.
