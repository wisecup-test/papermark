...
1. MUST: Queries for related entities SHALL use the ORM include or select directives to declare required relations and projections explicitly rather than performing separate queries and manual joins

## Policy Block

- MUST Queries for related entities SHALL use the ORM include or select directives to declare required relations and projections explicitly rather than performing separate queries and manual joins
