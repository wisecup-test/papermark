...
1. MUST: Asynchronous cloud service invocations MUST use event-driven client send operations that return promises for result handling

## Policy Block

- MUST Asynchronous cloud service invocations MUST use event-driven client send operations that return promises for result handling
