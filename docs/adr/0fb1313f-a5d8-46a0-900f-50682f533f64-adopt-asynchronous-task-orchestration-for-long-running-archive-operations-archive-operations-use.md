...
1. MUST: Archive operations MUST use streaming interfaces for hash computation and upload operations to avoid loading entire archives into memory

## Policy Block

- MUST Archive operations MUST use streaming interfaces for hash computation and upload operations to avoid loading entire archives into memory
