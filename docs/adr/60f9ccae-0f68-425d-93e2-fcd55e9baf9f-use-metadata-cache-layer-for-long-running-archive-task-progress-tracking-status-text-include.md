...
1. SHOULD: Status text SHOULD include batch numbers and totals when processing multiple batches to provide granular visibility

## Policy Block

- SHOULD Status text SHOULD include batch numbers and totals when processing multiple batches to provide granular visibility
