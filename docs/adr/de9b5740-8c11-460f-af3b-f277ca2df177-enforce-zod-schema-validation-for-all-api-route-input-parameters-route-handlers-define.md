...
1. MAY: Route handlers MAY define separate schemas for authenticated versus unauthenticated request contexts when validation requirements differ

## Policy Block

- MAY Route handlers MAY define separate schemas for authenticated versus unauthenticated request contexts when validation requirements differ
