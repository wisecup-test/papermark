...
1. MUST: Archive processing pipelines MUST register event handlers for error, entry, and completion events on stream-based archive objects to coordinate asynchronous operations

## Policy Block

- MUST Archive processing pipelines MUST register event handlers for error, entry, and completion events on stream-based archive objects to coordinate asynchronous operations
