...
1. MUST: All path parameters and query parameters used in authorization decisions or database queries MUST be validated against schemas defining expected types and formats

## Policy Block

- MUST All path parameters and query parameters used in authorization decisions or database queries MUST be validated against schemas defining expected types and formats
