...
1. MUST: Archive generation pipelines MUST use stream-based middleware to intercept data chunks for cross-cutting concerns such as hashing, progress tracking, and error handling.

## Policy Block

- MUST Archive generation pipelines MUST use stream-based middleware to intercept data chunks for cross-cutting concerns such as hashing, progress tracking, and error handling.
