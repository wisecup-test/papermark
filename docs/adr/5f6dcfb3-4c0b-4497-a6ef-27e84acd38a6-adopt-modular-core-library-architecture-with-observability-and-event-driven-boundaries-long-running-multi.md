...
1. MUST: All long-running or multi-step workflows MUST emit structured log events with contextual metadata at key lifecycle points to enable operational observability.

## Policy Block

- MUST All long-running or multi-step workflows MUST emit structured log events with contextual metadata at key lifecycle points to enable operational observability.
