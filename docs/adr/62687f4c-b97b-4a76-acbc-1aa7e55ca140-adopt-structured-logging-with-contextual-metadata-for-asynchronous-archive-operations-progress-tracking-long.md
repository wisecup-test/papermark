...
1. MUST: Progress tracking for long-running operations MUST use a dedicated metadata mechanism that records both numeric progress indicators and human-readable status text.

## Policy Block

- MUST Progress tracking for long-running operations MUST use a dedicated metadata mechanism that records both numeric progress indicators and human-readable status text.
