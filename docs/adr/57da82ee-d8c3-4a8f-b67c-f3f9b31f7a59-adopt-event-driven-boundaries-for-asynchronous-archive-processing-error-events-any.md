...
1. MUST: Error events from any stream in the pipeline MUST propagate to all dependent streams and trigger cleanup operations including upload abortion and resource destruction

## Policy Block

- MUST Error events from any stream in the pipeline MUST propagate to all dependent streams and trigger cleanup operations including upload abortion and resource destruction
