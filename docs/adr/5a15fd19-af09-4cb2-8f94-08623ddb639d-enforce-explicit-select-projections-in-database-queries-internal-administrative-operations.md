...
1. MAY: Internal administrative operations may retrieve full entities when operating within trusted boundaries and when audit logging captures the access

## Policy Block

- MAY Internal administrative operations may retrieve full entities when operating within trusted boundaries and when audit logging captures the access
