...
1. SHOULD: Validation schemas SHOULD be defined as reusable schema objects and imported into route handlers rather than defined inline

## Policy Block

- SHOULD Validation schemas SHOULD be defined as reusable schema objects and imported into route handlers rather than defined inline
