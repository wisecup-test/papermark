...
1. MUST: CUID identifiers used in where clauses MUST be validated as valid CUID format strings before use in queries

## Policy Block

- MUST CUID identifiers used in where clauses MUST be validated as valid CUID format strings before use in queries
