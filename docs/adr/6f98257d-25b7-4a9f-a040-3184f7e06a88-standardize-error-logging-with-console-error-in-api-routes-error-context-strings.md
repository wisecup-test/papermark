...
1. SHOULD: Error context strings SHOULD identify the specific resource or operation type to enable log aggregation and filtering

## Policy Block

- SHOULD Error context strings SHOULD identify the specific resource or operation type to enable log aggregation and filtering
