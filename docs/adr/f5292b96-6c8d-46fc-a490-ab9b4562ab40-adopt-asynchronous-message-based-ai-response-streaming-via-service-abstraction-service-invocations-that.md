...
1. MUST: Service invocations that produce streaming responses MUST accept all required context parameters including chat identifier, message content, vector store identifier, filtered document identifiers, and optional dataroom or link identifiers.

## Policy Block

- MUST Service invocations that produce streaming responses MUST accept all required context parameters including chat identifier, message content, vector store identifier, filtered document identifiers, and optional dataroom or link identifiers.
