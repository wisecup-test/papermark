...
1. MUST: Long-running archive operations MUST be implemented as asynchronous task functions that coordinate multiple concurrent workflows rather than synchronous request handlers

## Policy Block

- MUST Long-running archive operations MUST be implemented as asynchronous task functions that coordinate multiple concurrent workflows rather than synchronous request handlers
