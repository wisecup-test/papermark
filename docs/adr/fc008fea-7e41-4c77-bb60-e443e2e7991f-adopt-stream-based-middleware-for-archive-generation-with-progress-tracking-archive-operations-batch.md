...
1. SHOULD: Archive operations SHOULD batch documents based on size constraints and generate separate archives with coordinated progress tracking across batches.

## Policy Block

- SHOULD Archive operations SHOULD batch documents based on size constraints and generate separate archives with coordinated progress tracking across batches.
