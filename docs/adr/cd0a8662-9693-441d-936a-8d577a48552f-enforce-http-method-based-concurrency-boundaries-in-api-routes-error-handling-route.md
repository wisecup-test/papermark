...
1. MUST: Error handling in route handlers MUST ensure that partial database operations are rolled back and that error responses do not leak sensitive information about database state or structure.

## Policy Block

- MUST Error handling in route handlers MUST ensure that partial database operations are rolled back and that error responses do not leak sensitive information about database state or structure.
