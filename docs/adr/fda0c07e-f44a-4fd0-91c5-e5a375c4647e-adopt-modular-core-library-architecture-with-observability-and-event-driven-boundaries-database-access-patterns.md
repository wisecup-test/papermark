...
1. MUST: Database access patterns MUST separate read projections from write operations, using explicit select clauses to minimize data transfer and include clauses to control relationship loading.

## Policy Block

- MUST Database access patterns MUST separate read projections from write operations, using explicit select clauses to minimize data transfer and include clauses to control relationship loading.
