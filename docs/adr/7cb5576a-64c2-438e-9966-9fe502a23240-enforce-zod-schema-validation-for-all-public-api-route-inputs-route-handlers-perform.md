...
1. MAY: Route handlers MAY perform additional business-logic validation after schema validation passes for constraints requiring database lookups or complex rules

## Policy Block

- MAY Route handlers MAY perform additional business-logic validation after schema validation passes for constraints requiring database lookups or complex rules
