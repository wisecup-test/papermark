...
1. SHOULD: Structured log metadata SHOULD include computed metrics such as row counts, file counts, and size conversions to facilitate operational analysis without post-processing.

## Policy Block

- SHOULD Structured log metadata SHOULD include computed metrics such as row counts, file counts, and size conversions to facilitate operational analysis without post-processing.
