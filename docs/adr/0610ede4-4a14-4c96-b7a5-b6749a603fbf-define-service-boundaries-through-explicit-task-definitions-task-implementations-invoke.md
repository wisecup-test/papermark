...
1. MAY: Task implementations MAY invoke external services through client SDK abstractions when cross-service coordination is required

## Policy Block

- MAY Task implementations MAY invoke external services through client SDK abstractions when cross-service coordination is required
