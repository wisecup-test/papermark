...
1. MUST: Progress metadata MUST be updated at defined checkpoints during archive operations to provide incremental feedback on operation status

## Policy Block

- MUST Progress metadata MUST be updated at defined checkpoints during archive operations to provide incremental feedback on operation status
