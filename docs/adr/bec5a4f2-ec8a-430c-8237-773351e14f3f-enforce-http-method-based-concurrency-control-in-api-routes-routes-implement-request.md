...
1. MAY: Routes MAY implement request-specific logging for security-sensitive operations such as authentication failures or authorization denials

## Policy Block

- MAY Routes MAY implement request-specific logging for security-sensitive operations such as authentication failures or authorization denials
