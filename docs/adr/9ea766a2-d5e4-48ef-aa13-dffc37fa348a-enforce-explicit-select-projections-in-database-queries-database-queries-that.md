...
1. MUST: All database queries that retrieve entities containing sensitive fields or personally identifiable information must include an explicit select clause enumerating only the required fields

## Policy Block

- MUST All database queries that retrieve entities containing sensitive fields or personally identifiable information must include an explicit select clause enumerating only the required fields
