...
1. MUST: All database mutations MUST include ownership or team membership verification in the WHERE clause to prevent unauthorized modifications

## Policy Block

- MUST All database mutations MUST include ownership or team membership verification in the WHERE clause to prevent unauthorized modifications
