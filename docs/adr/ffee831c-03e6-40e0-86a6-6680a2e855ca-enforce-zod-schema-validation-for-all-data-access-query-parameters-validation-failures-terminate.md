...
1. MUST: Validation failures MUST terminate request processing and return appropriate error responses before any database operation is attempted

## Policy Block

- MUST Validation failures MUST terminate request processing and return appropriate error responses before any database operation is attempted
