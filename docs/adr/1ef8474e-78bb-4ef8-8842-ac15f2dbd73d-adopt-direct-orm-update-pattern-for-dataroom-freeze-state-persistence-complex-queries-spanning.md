...
1. SHOULD: Complex queries spanning multiple relations SHOULD use orderBy directives to ensure deterministic result ordering for version selection and audit trail generation

## Policy Block

- SHOULD Complex queries spanning multiple relations SHOULD use orderBy directives to ensure deterministic result ordering for version selection and audit trail generation
