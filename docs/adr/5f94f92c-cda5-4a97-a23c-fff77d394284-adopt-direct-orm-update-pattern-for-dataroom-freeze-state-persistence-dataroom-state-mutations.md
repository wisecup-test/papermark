...
1. MUST: All dataroom state mutations that persist archive artifacts SHALL use the ORM update method with explicit where clauses specifying both entity identifier and team identifier to enforce multi-tenant isolation

## Policy Block

- MUST All dataroom state mutations that persist archive artifacts SHALL use the ORM update method with explicit where clauses specifying both entity identifier and team identifier to enforce multi-tenant isolation
