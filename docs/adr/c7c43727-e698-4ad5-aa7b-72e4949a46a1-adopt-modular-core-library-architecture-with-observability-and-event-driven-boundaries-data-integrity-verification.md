...
1. MUST: Data integrity verification MUST be implemented using middleware-style stream transformations that compute hashes or checksums inline with data flow.

## Policy Block

- MUST Data integrity verification MUST be implemented using middleware-style stream transformations that compute hashes or checksums inline with data flow.
