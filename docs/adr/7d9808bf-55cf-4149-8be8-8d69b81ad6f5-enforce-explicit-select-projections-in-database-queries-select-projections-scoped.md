...
1. MUST: Select projections must be scoped to the minimum set of fields necessary for the operation's business logic and response contract

## Policy Block

- MUST Select projections must be scoped to the minimum set of fields necessary for the operation's business logic and response contract
