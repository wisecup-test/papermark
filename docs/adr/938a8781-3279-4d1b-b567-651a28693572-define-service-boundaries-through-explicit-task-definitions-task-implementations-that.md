...
1. MUST: Task implementations that depend on versioned SDK libraries MUST discover the exact resolved version from the project's lock artifact before implementation

## Policy Block

- MUST Task implementations that depend on versioned SDK libraries MUST discover the exact resolved version from the project's lock artifact before implementation
