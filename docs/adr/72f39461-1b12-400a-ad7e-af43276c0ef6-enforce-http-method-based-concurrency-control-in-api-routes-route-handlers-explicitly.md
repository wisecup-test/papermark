...
1. MUST: All API route handlers MUST explicitly declare which HTTP methods they accept and reject requests with unsupported methods before processing

## Policy Block

- MUST All API route handlers MUST explicitly declare which HTTP methods they accept and reject requests with unsupported methods before processing
