...
1. MUST: All API route handlers that perform database write operations (create, update, delete) MUST use HTTP methods that signal write intent (POST, PATCH, PUT, DELETE) and MUST NOT use GET for state-modifying operations.

## Policy Block

- MUST All API route handlers that perform database write operations (create, update, delete) MUST use HTTP methods that signal write intent (POST, PATCH, PUT, DELETE) and MUST NOT use GET for state-modifying operations.
