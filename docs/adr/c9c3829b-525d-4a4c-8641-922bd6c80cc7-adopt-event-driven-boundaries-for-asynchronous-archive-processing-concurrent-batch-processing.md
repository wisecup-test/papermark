...
1. MAY: Concurrent batch processing operations MAY execute in parallel when batch independence is guaranteed by the data access pattern

## Policy Block

- MAY Concurrent batch processing operations MAY execute in parallel when batch independence is guaranteed by the data access pattern
