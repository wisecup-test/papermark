...
1. SHOULD: Database queries that check existence before mutation SHOULD be combined into atomic operations where the database system supports it

## Policy Block

- SHOULD Database queries that check existence before mutation SHOULD be combined into atomic operations where the database system supports it
