...
1. MUST: Archive metadata updates SHALL include both the storage location reference and cryptographic hash in a single atomic data payload to maintain consistency between location and content verification

## Policy Block

- MUST Archive metadata updates SHALL include both the storage location reference and cryptographic hash in a single atomic data payload to maintain consistency between location and content verification
