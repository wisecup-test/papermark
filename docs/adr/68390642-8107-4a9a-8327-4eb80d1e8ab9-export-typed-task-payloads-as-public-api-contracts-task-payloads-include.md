...
1. SHOULD: Task payloads SHOULD include identifiers sufficient for correlation with observability logs and database records

## Policy Block

- SHOULD Task payloads SHOULD include identifiers sufficient for correlation with observability logs and database records
