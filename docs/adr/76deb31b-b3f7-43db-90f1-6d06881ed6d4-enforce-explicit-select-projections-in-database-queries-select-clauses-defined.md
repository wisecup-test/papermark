...
1. SHOULD: Select clauses should be defined near the query invocation rather than abstracted into distant helper functions to maintain visibility of data access patterns

## Policy Block

- SHOULD Select clauses should be defined near the query invocation rather than abstracted into distant helper functions to maintain visibility of data access patterns
