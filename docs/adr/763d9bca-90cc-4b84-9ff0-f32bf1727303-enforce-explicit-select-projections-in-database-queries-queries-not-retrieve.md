...
1. MUST_NOT: Queries must not retrieve entire entity graphs without select clauses when the entity contains fields marked as sensitive or when the query crosses tenant boundaries

## Policy Block

- MUST_NOT Queries must not retrieve entire entity graphs without select clauses when the entity contains fields marked as sensitive or when the query crosses tenant boundaries
