...
1. MUST: Progress metadata updates MUST be coordinated through a cache layer that supports atomic set operations for tracking pipeline milestones.

## Policy Block

- MUST Progress metadata updates MUST be coordinated through a cache layer that supports atomic set operations for tracking pipeline milestones.
