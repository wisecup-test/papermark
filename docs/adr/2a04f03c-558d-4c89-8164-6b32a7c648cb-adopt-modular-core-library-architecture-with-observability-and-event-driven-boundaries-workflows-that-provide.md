...
1. SHOULD: Workflows that provide user-facing feedback SHOULD use the cache layer to persist progress metadata and status text at incremental completion points.

## Policy Block

- SHOULD Workflows that provide user-facing feedback SHOULD use the cache layer to persist progress metadata and status text at incremental completion points.
