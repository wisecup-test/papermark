...
1. MUST: Feature modules MUST import core infrastructure libraries from the designated internal library path rather than directly instantiating external service clients.

## Policy Block

- MUST Feature modules MUST import core infrastructure libraries from the designated internal library path rather than directly instantiating external service clients.
