...
1. MUST: Background operations that coordinate multiple subsystems MUST be defined as discrete task definitions with explicit payload contracts

## Policy Block

- MUST Background operations that coordinate multiple subsystems MUST be defined as discrete task definitions with explicit payload contracts
