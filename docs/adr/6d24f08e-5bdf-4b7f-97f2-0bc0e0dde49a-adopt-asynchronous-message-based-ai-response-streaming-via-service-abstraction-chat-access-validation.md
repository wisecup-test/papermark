...
1. MUST: Chat access validation MUST occur before service invocation, using database queries that verify chat existence and retrieve associated configuration including vector store and message history.

## Policy Block

- MUST Chat access validation MUST occur before service invocation, using database queries that verify chat existence and retrieve associated configuration including vector store and message history.
