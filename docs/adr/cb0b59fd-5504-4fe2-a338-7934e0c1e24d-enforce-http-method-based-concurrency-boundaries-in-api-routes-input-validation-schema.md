...
1. MUST: Input validation using schema parsers MUST complete successfully before any database operation begins, and validation failures MUST prevent database access.

## Policy Block

- MUST Input validation using schema parsers MUST complete successfully before any database operation begins, and validation failures MUST prevent database access.
