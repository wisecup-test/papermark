...
1. MUST: CUID identifiers in path parameters and request bodies MUST be validated against the CUID format specification

## Policy Block

- MUST CUID identifiers in path parameters and request bodies MUST be validated against the CUID format specification
