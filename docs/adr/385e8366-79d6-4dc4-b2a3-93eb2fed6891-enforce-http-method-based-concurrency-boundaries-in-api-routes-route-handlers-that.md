...
1. MUST: Route handlers that query database entities with authorization checks MUST perform authorization validation before executing queries, and MUST NOT retrieve data that the requester is not authorized to access.

## Policy Block

- MUST Route handlers that query database entities with authorization checks MUST perform authorization validation before executing queries, and MUST NOT retrieve data that the requester is not authorized to access.
