...
1. MUST: Task payload types SHALL define all required parameters for task execution without relying on implicit context or ambient state

## Policy Block

- MUST Task payload types SHALL define all required parameters for task execution without relying on implicit context or ambient state
