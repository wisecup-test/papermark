...
1. SHOULD: Progress values SHOULD increment monotonically and reflect proportional completion across all workflow stages

## Policy Block

- SHOULD Progress values SHOULD increment monotonically and reflect proportional completion across all workflow stages
