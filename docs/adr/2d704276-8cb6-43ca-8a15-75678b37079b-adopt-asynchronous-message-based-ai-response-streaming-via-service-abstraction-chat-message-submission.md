...
1. MUST: AI chat message submission endpoints MUST delegate message processing and response generation to a dedicated service abstraction rather than implementing streaming logic inline within the route handler.

## Policy Block

- MUST AI chat message submission endpoints MUST delegate message processing and response generation to a dedicated service abstraction rather than implementing streaming logic inline within the route handler.
