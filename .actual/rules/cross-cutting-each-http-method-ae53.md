...
- **R-HTTP-001** MUST: Each HTTP method handler MUST apply method-specific input validation using schema validation before accessing request body or query parameters.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All route handlers must demonstrate method-specific validation and authorization enforcement before acceptance.
</enforcement>