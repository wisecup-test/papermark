# Validate Input Before Logging Error Context: Database Access Patterns
...
- **R-VALIDATE-001** SHOULD: Database access patterns SHOULD only execute after input validation succeeds, ensuring logged database errors reference validated identifiers.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All error logging in route handlers MUST be audited to confirm it occurs only after input validation succeeds.
</enforcement>